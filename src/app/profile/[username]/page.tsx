...
const MediaCollage = ({
  ...
  // 5 or more items (collage style matching user screenshot: Left has 2 rows, Right has 3 rows)
      ...
      <div className="flex flex-col gap-1.5 w-1/2 h-full">
        ...
        >
          {media[3].type === "VIDEO" ? (
            ...
            <img src={media[3].url} className="w-full h-full object-cover" alt="" />
          )}
          <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
            <span className="text-[9px] bg-primary text-primary-foreground font-bold px-2.5 py-1.5 rounded-lg">
              Open
      ...
      <div className="flex flex-col gap-1.5 w-1/2 h-full">
        ...
        >
          {media[1].type === "VIDEO" ? (
            ...
            <img src={media[1].url} className="w-full h-full object-cover" alt="" />
          )}
          <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
            <span className="text-[8px] bg-primary text-primary-foreground font-bold px-2 py-1 rounded">
              Open
        ...
        >
          {media[2].type === "VIDEO" ? (
            ...
            <img src={media[2].url} className="w-full h-full object-cover" alt="" />
          )}
          <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
            <span className="text-[8px] bg-primary text-primary-foreground font-bold px-2 py-1 rounded">
              Open
        ...
        >
          {media[4].type === "VIDEO" ? (
            ...
            <img src={media[4].url} className="w-full h-full object-cover" alt="" />
          )}
          {remaining > 0 ? (
